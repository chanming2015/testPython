...
def plotNode(nodeTxt, cntrPt, parentPt, nodeType):
    createPlot.ax1.annotate(nodeTxt, xy=parentPt, xycoords='axes fraction', xytext=cntrPt, textcoords='axes fraction', va='center', ha='center', bbox=nodeType, arrowprops=arrow_args)
...
def createPlot(inTree):
    ...
    plotTree.totalID = float(getTreeDepth(inTree))
